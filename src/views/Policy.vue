<template>
  <v-container>
    ...
    <p class="text">
      <b>Penhwonders</b> (“us”, “we”, or “our”) operates
      <b>penhwonders.com</b> (hereinafter referred to as <b>“Service”</b>).
    </p>
    <p class="text">
      Our Privacy Policy governs your visit to <b>penhwonders.com</b>, and
    ...
    <p class="text">
      <b>SERVICE</b> means the penhwonders.com website operated by Penhwonders.
    </p>
    <p class="text">
    ...
    <p class="text">
      Penhwonders uses the collected data for various purposes:
    </p>
    ...
    <p class="text">
      Penhwonders will take all the steps reasonably necessary to ensure that
    ...
    <p class="text">
      ...
      send your request(s) by email: <b>contact@penhwonders.com</b>.
    </p>
    <p class="text">
    ...
    <p style="margin-top: 5em; font-size: 0.7em">
      ...
      <a href="https://policymaker.io">PolicyMaker.io</a> on 2021-04-21.
    </p>
  </v-container>
</template>
